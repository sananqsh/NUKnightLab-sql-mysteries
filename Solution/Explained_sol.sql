...
-- Witnesses:
	...
	--!!! looks like our guy, Joe Germuska has an unregistered license !!!
...
-- Comparing suspects:
	-- 67318: matches plate number
	-- 	   was on the crime scene according to Facebook

	-- 28819: his license_id is not registered! ORRR does not have a car!!!
	-- 	   does not have a logged income!
	-- 	   no event on Facebook.
